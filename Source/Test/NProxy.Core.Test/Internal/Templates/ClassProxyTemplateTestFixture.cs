...
{
    [TestFixture]
    public sealed class ClassProxyTemplateTestFixture
    {
        [Test]
        public void AcceptVisitorTest()
        {
            // Arrange
            var proxyTemplate = new ClassProxyTemplate(typeof (Other), new[] {typeof (IOne), typeof (ITwo), typeof (IOneTwo)});
        ...
        {
            // Arrange
            var firstProxyTemplate = new ClassProxyTemplate(typeof (Other), Type.EmptyTypes);
            var secondProxyTemplate = new ClassProxyTemplate(typeof (Other), Type.EmptyTypes);
        ...
        {
            // Arrange
            var firstProxyTemplate = new ClassProxyTemplate(typeof (Other), new[] {typeof (IOne), typeof (ITwo)});
            var secondProxyTemplate = new ClassProxyTemplate(typeof (Other), new[] {typeof (ITwo), typeof (IOne)});
        ...
        {
            // Arrange
            var firstProxyTemplate = new ClassProxyTemplate(typeof (Other), new[] {typeof (IOther)});
            var secondProxyTemplate = new ClassProxyTemplate(typeof (Other), Type.EmptyTypes);
