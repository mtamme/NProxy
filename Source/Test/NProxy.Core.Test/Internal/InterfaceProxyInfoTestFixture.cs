...
{
    [TestFixture]
    public sealed class InterfaceProxyInfoTestFixture
    {
        [Test]
        public void AcceptVisitorTest()
        {
            // Arrange
            var proxyInfo = new InterfaceProxyInfo(typeof (IOne), new[] {typeof (ITwo), typeof (IOneTwo)});
            ...
            // Assert
            Assert.That(proxyInfo.DeclaringType, Is.EqualTo(typeof (IOne)));
        ...
        {
            // Arrange
            var firstProxyInfo = new InterfaceProxyInfo(typeof (IBase), Type.EmptyTypes);
            var secondProxyInfo = new InterfaceProxyInfo(typeof (IBase), Type.EmptyTypes);
        ...
        {
            // Arrange
            var firstProxyInfo = new InterfaceProxyInfo(typeof (IBase), new[] {typeof (IOne), typeof (ITwo)});
            var secondProxyInfo = new InterfaceProxyInfo(typeof (IBase), new[] {typeof (ITwo), typeof (IOne)});
        ...
        {
            // Arrange
            var firstProxyInfo = new InterfaceProxyInfo(typeof (IOne), new[] {typeof (IBase)});
            var secondProxyInfo = new InterfaceProxyInfo(typeof (IOne), Type.EmptyTypes);
